...
async function toggleCamera() {
  ...
  try {
    ...
    cameraOverlay.querySelector(".camera-message").textContent =
...
function captureImage() {
  ...
  // Option 1: Use the backend API for server-side capture (recommended for consistency)
  performManualCapture();

  /* Option 2: Client-side capture to preview before analysis
